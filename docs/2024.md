...
There are totally **31** questions have been solved in 2024, including **24** questions in easy, **6** questions in medium and **1** questions in hard.
...
Solved **3** questions in february:
- **2** questions in easy.
