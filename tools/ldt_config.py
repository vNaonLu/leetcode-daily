...
@cli.command(
    ...
    name="config", prog=CONFIG_SCRIPT_NAME,
    help=fixedWidth(f"edit the configuration for {SCRIPT_NAME}.", width=60),
...
@cli.command(
    cli.arg("session_name", metavar="Session_Name", default="",
    ...
    formatter_class=RawTextHelpFormatter,
    parent=ldtConfig, name="session", prog=CONFIG_SESSION_SCRIPT_NAME,
