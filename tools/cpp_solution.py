...
class CPPSoltuion:
    ...
    def __bool__(self):
        return self._code_snippet and self._code_snippet.__bool__()
    ...
    def solutionTemplate(self) -> str:
        ...
        if len(self._content_info.constraints) > 0:
            constrains_section = concat(
                f'// Inputs Should Be Obey The Constraints Below:',
        ...
        return concat(
            ...
            f'// This Solution Source Is Generated by |{SCRIPT_NAME}|.',
            f'//',
            ...
            f'//',
            f'// ' + regex.sub('\n+', '\n// ', self._content_info.description.content),
            f'',
