 ...
 *   no other cities outside of the
 *   You are given an ‘n x n’ matrix ‘isConnected’ where ‘isConnected[i][j]
 *   = 1’ if the ‘iᵗʰ’ city and the ‘jᵗʰ’ city are directly connected, and
 *   ‘isConnected[i][j] = 0’
...
struct q547 : public ::testing::Test {
...
TEST_F(q547, sample_input01) {
  solution = new Solution();
  vector<vector<int>> isConnected = {{1, 1, 0}, {1, 1, 0}, {0, 0, 1}};
  int exp = 2;
  EXPECT_EQ(solution->findCircleNum(isConnected), exp);
  delete solution;
}

TEST_F(q547, sample_input02) {
  solution = new Solution();
