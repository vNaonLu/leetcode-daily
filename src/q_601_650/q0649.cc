...
// Description of |649. Dota2 Senate|:
//
...
// Then if there are |n| senators, the size of the given string will be |n|. The
...
LEETCODE_BEGIN_RESOLVING(649, Dota2Senate, Solution);
...
LEETCODE_SOLUTION_UNITTEST(649, Dota2Senate, example_1) {
  auto   solution = MakeSolution();
  string senate   = "RD";
  string expect   = "Radiant";
...
// The first senator comes from Radiant and he can just ban the next senator's
// right in round 1. And the second senator can't exercise any rights anymore
// since his right has been banned. And the third senator comes from Dire and he
// can ban the first senator's right in round 1. And in round 2, the third
// senator can just announce the victory since he is the only guy in the senate
// who can vote.

LEETCODE_SOLUTION_UNITTEST(649, Dota2Senate, example_2) {
  auto   solution = MakeSolution();
  string senate   = "RDD";
  string expect   = "Dire";
  string actual   = solution->predictPartyVictory(senate);
