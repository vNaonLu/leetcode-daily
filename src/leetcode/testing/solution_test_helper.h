...
#define _LEETCODE_SOLUTION_NAMESPACE_NAME(id, name) q##id##name##Anon

#define LEETCODE_SOLUTION_NAMESPACE(id, name)                                  \
  namespace _LEETCODE_SOLUTION_NAMESPACE_NAME(id, name)

#define LEETCODE_BEGIN_RESOLVING(id, name, solve_class)                        \
  LEETCODE_SOLUTION_NAMESPACE(id, name) {                                      \
    ...
    public:                                                                    \
      ...
      protected:                                                               \
        ...
        std::unique_ptr<solve_class> Make##solve_class(ArgsType &&...args) {   \
          return std::make_unique<solve_class>(                                \
...
#define LEETCODE_SOLUTION_UNITTEST_WITH_TIMED_OUT(id, name, suite_name, time)  \
  LEETCODE_SOLUTION_NAMESPACE(id, name) {                                      \
    ...
    TEST_F(_LEETCODE_UNITTEST_FIXTURE_NAME(id, name), suite_name) {            \
      using LEETCODE_SOLUTION_NAMESPACE(id, name);                             \
      auto delegate =                                                          \
  ...
  void _LEETCODE_SOLUTION_NAMESPACE_NAME(                                      \
      id, name)::_LEETCODE_SOLUTION_UNITTEST_DELEGATE_NAME(id, name,           \
                                                           suite_name)::Run()
