...
struct q144 : public ::testing::Test {
...
TEST_F(q144, sample_input01) {
  solution = new Solution();
  TreeNode* root = TreeNode::generate({1, NULL_TREENODE, 2, 3});
  vector<int> exp = {1, 2, 3};
  EXPECT_EQ(solution->preorderTraversal(root), exp);
  delete solution;
}

TEST_F(q144, sample_input02) {
  solution = new Solution();
