...
// Description of |2220. Minimum Bit Flips to Convert Number|:
//
...
LEETCODE_BEGIN_RESOLVING(2220, MinimumBitFlipsToConvertNumber, Solution);
...
// Output: 3
//
// The binary representation of 10 and 7 are 1010 and 0111 respectively. We can
// convert 10 to 7 in 3 steps:
...
LEETCODE_SOLUTION_UNITTEST(2220, MinimumBitFlipsToConvertNumber, example_1) {
  auto solution = MakeSolution();
  int  start    = 10;
  int  goal     = 7;
  int  expect   = 3;
  int  actual   = solution->minBitFlips(start, goal);
...
// Output: 3
//
// The binary representation of 3 and 4 are 011 and 100 respectively. We can
// convert 3 to 4 in 3 steps:
...
LEETCODE_SOLUTION_UNITTEST(2220, MinimumBitFlipsToConvertNumber, example_2) {
  auto solution = MakeSolution();
  int  start    = 3;
  int  goal     = 4;
  int  expect   = 3;
