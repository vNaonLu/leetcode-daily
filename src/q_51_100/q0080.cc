...
// Description of |80. Remove Duplicates from Sorted Array II|:
//
...
LEETCODE_BEGIN_RESOLVING(80, RemoveDuplicatesFromSortedArrayII, Solution);
...
// 1, 1, 2, 2 and 3 respectively. It does not matter what you leave beyond the
// returned k (hence they are underscores).

LEETCODE_SOLUTION_UNITTEST(80, RemoveDuplicatesFromSortedArrayII, example_1) {
...
// being 0, 0, 1, 1, 2, 3 and 3 respectively. It does not matter what you leave
// beyond the returned k (hence they are underscores).

LEETCODE_SOLUTION_UNITTEST(80, RemoveDuplicatesFromSortedArrayII, example_2) {
  auto        solution = MakeSolution();
